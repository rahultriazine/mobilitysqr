    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid_disp', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_name', models.CharField(blank=True, max_length=100)),
                ('category_id', models.IntegerField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(blank=True, choices=[('Tax Payer', 'Tax Payer'), ('Spouse', 'Spouse'), ('Joint', 'Joint')], max_length=100, null=True)),
        ...
        migrations.AddField(
            ...
            name='vendor_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='master.Vendor_Status'),
        ),
        migrations.AlterUniqueTogether(
            name='vendor_master',
